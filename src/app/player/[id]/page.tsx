      ...
      <div className="flex items-center justify-between px-4 pt-[max(1rem,env(safe-area-inset-top))] pb-4 animate-slide-down">
        ...
        <div className="flex items-center gap-1">
          <button
            ...
            className="active:scale-90 transition-all duration-150 p-3"
          >
            <svg className="w-5 h-5 text-white/60 hover:text-white transition-colors" fill="currentColor" viewBox="0 0 24 24">
